...
public class Module extends SimpleBindings implements RequireFunction {
    ...
    public Module(NashornScriptEngine engine, Folder folder, ModuleCache cache, String filename, Bindings module,
            Bindings exports, Module parent, Module main) throws ScriptException {
    ...
    private Module searchForModuleInNodeModules(Folder resolvedFolder, String[] folderParts, String filename)
    ...
    private Module compileJavaScriptModule(Folder parent, String fullPath, String code) throws ScriptException {
        ...
        // try {
        //
        // // for (Entry<String, Object> b : engineScope.entrySet()) {
        // // System.out.println("Module.compileJavaScriptModule()" + b.getKey());
        // // }
        //
        ...
        try {
            ...
            ScriptObjectMirror function = (ScriptObjectMirror) engine
